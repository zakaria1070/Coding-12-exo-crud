...
@foreach ($testimonials as $testimonial)
      ...
      <div class="row">
        <div class="col-md-3">
          <div class="profile">
          <div class="pic"><img src="{{$testimonial->image}}" alt=""></div>
        ...
        <div class="col-md-9">
          <div class="quote">
            <b><img src="img/quote_sign_left.png" alt=""></b> {{$testimonial->description}} <small><img src="img/quote_sign_right.png" alt=""></small>
          </div>
        </div>
      </div>
@endforeach
