    ...
    <div class="container">
      <form method="post" action="/testimonial/{{$testimonials->id}}/update">
        ...
        <div class="form-group">
          ...
          <input type="text" value="{{$testimonials->titre}}" name="titre" class="form-control" id="" aria-describedby="emailHelp">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <input type="text" name='image' value=" {{$testimonials->image}} " class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
        </div>
